...
import org.example.androidnewsbackend.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public String getAuthoristation(String username){

        return  userRepository.findByUsername(username).getRoles().getFirst().getName();
